...
var codeMapping = {
  ...
  Z:
    'non optimizable page (will never be optimized, 404, 301, 302, POST, etc.).',
  ...
  t:
    'timeout, the optimization has taken too much time, the page is not optimized',
  ccb:
  ...
  of:
    'Overflow, show that overflow system is in place. Following flags clarify the results.',
  '!id': 'No id',
